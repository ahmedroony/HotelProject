...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md m-4">
        <h2 class="text-3xl font-bold text-center text-gray-800 mb-6">Guest Login</h2>
        ...
        <div class="mt-6 text-center text-sm text-gray-600">
            ...
            <a href="{{ route('guest.register.form') }}" class="font-medium text-blue-600 hover:text-blue-500 ml-1">Register</a>
        </div>
    </div>
</body>
</html>
