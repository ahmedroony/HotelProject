        ...
        <div class="container">
            ...
            <div class="row check-availabilty" id="next">
                <div class="block-32" data-aos="fade-up" data-aos-offset="-200">
                    ...
                    <form method="GET" action="{{ route('check.availability') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                                ...
                                <input type="date" name="checkin_date" id="checkindate" class="form-control">
                            ...
                            <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                                ...
                                <div class="icon"><span class="icon-calendar"></span></div>
                                <input type="date" name="checkout_date" id="checkoutdate" class="form-control">
                            ...
                            <div class="col-md-6 mb-3 mb-md-0 col-lg-3">
                                <div class="row">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        ...
                                        <input type="number" name="adults" value="1" id="adults"
                                            class="form-control">
                                    </div>
                                    <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <div class="col-md-6 col-lg-3 align-self-end">
                                <input type="submit" value="Check Availabilty" class="btn btn-primary btn-block text-white">
                            </div>
                        </div>
                    </form>
                </div>
